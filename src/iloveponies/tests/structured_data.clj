...
(let [china {:name "China Miéville", :birth-year 1972}
  ...
  (facts "books->string" {:exercise 29
    ...
    (books->string [little-schemer, cities, wild-seed])
      => "3 books. The City and the City, written by China Miéville (1972 - ). Wild Seed, written by Octavia E. Butler (1947 - 2006). The Little Schemer, written by Daniel Friedman (1944 - ), Matthias Felleisen."
